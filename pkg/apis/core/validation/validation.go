...
// ValidateControllerInstance tests that the specified controller instance fields has valid data
...
// ValidateControllerInstanceUpdate tests make sure a controller instance update can be applied.
